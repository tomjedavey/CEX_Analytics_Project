...
In addition to the above, I believe something that I have learnt as a result of getting to the end of this project is the importance of strong versioning control. A big mistake I will learn from is a lack of making each push to this repository (code update) a significant and well noted change. This generally links to issues related to making a project such as this useable in terms of other people being able to understand how a repository has developed, what all functionality does and how they complete what is intended and more along these lines. To improve upon this, taking more care in the way that I test workflow changes and push to a repository will be a priority in future projects to improve my ability to work with others in this type of a way. This also links to methods needed to ensure coding standards through use of "utils" functions. What I mean here is that if I were to build functions in the utils subfolder of the Source_Code_Packages folder that can be imported to other files to check for bugs, working times and other related concepts, then others may be able to more easily understand and work with my code by checking the quality standards easier and pinpointing potential bugs. 

Aside from the ways in which this repository and project was developed in terms of the technical methods, the concept of what is being created (conceptualised using thinking related to the TLADS book talked about below) is in cases overkill in terms of complexity for what is aspired to be achieved. A good example of this can be the interaction mode score, which takes on a much more complex derivation in order to try to add more context of a wallet's position related to the whole dataset but fails to account for the tendancies of the data and therefore, although still capturing effective understanding of interaction with the respective event types in results, doesn't work to the advantage hoped for. More evaluation on areas such as this are touched upon in the Manual_Analysis_and_Recommendations_Report.md

And finally, the main point with regards to the development of my skills and my building approach in this project is my use of AI with the methods described in the TLADS methodology (see below section). Of course, it is incredibly easy to produce complex functionality with AI copilots and LLMs which are powerful and definetly useable in today's world. However, I understood before taking on this project that to oversimplify and overestimate the ability of AI models in producing what you intend to produce (in what is sometimes described as "vibe coding"), only leads to weak functionality that likely offers large layers of errors that fail to capture what you want to build when you start to uncover issues. 

Given this mindset before approaching this project, I set out to focus on building concepts and analytic functions that are based off of clear and practical thinking utilising ideas and concepts brainstormed and understood making use of the TLADS methodologies and canvases in a way that accounts for the power and issues with using AI to develop this type of a functionality. This approach consisted of using AI to produce small parts of a file from which a structure has already been decided upon, and then from there making sure that I understand the code built in every case and how they work. Making clear notes and taking a structured and careful approach here I believe allows me to ensure strong development standards whilst still maintaining efficiency needed in today's industry. This is something I have refined upon throughout production of this project and is something that I also increasingly used in debugging files, understanding how to go about using Github and more. 

To use AI in the best way possible to enhance analytic value provision ability and efficiency is a skill that is extremely necessary in the current state of the data analytics and science industry and is something that I prioritised in my approach and initial thoughts for producing a project such as this. In my opinion regarding this, AI is no replacement for technical understanding but simply something that needs to be used to build and create in aid of this technical understanding to produce efficiency of development and learning and allow for professionals in data analytics to focus on what matters most: linking to and delivering on business relevance in your work. 

## 10. Next Steps Possible With Actual Application

The following is not necessarily focused on explaining what improvements I intend to make based on what I have learnt and the challenges I have faced in this project described above, but more the possibilities that could be achieved in terms of improving this analytic value in the case of actually applying this type of a project in real work. 

One of the largest things that would be changed with application to actual CEX stakeholders would be changes with the raw data being inputted. Of course, in working with a CEX access to their user data is the largest thing needed to make actionable difference in this type of a project. Naturally, there is additional data privacy concerns to be considered with this, but integration of user data to be able to analyse only the wallets that relate to the CEX is what would be important (and would allow for replacement of placeholders such as the revenue proxy score) and is the biggest step needed to actually produce actionable insights. Additionally to this, improving the scope of the data to a much larger amount of different blockchains and considering data flow by automatically updating data periodically is another significant step towards increasing the reach of analytic value in this type of project. All of these improvements would require updates to infrastructure in terms of gaining the data through APIs with onchain crypto data as well as internal CEX data which is all achievable with the correct levels of access. The current data is simply one period of Polygon blockchain data, practical for explaining how to analyse this type of data with the methods produced but something that has incredible opportunities for improvement in actual implementation.

Another large oppportunity for improvement can be seen in the scope of analytic scores being produced. In the case of this project, a small amount of analytic scores have been produced to give example of the concepts being looked at. However, with more data and more functionality in a project such as this, a much greater view of each wallet's behaviour can be seen and from here more informed decision making is possible by making more analytic scores. 

The above allows for a much larger depth of visualisations and as a result a broader view of the analytic insight available to identify potential "behavioural archetypes" that model groups of wallets/users based on common behaviours. This links in with another obvious improvement being a much more improved dashboard in terms of organisation and what is being shown overall. Business intelligence dashboard technology could be integrated here and a more interactive dashboard and visualisation useability could make it easier for CEX stakeholders and users to change and test different configurations, options and more. An extension of this links to the work of the TLADS methodology mentioned below, step 8 of this methodology refers to a feedback loop and learning based UEX (user experience). What this means is a situation where someone would work on a project such as this with a CEX and work closely with the relevant stakeholders in order to continuously refine and change the dashboards being outputted based on actual decision outcomes being made. This means that the relevant stakeholder's feedback guides what is being produced in this project into something that truly identifies with the goals of stakeholders (in the business intiative and given the use case) and truly improves key decision making.

All of the above possibilities relate to improving the ability of this project to provide relevant and actionable insight of wallets and users that use a CEX. The opportunities are limitless and of course change over time as crypto markets develop and the services provided in the CEX industry expand. 

## 11. Acknowledgements and References

The main document that was used throughout thinking and in understanding the data analytics and science industry in application to this project was the Thinking Like a Data Scientist (TLADS) book by Bill Schmarzo. This provided great inspiration to what was taken on as explained below.

More detail on the data source is included in the data_description.md file in the data/raw_data directory, but to add brief knowledge the raw data used to produce the output in this file, this data is sourced from Flipside Crypto on the Snowflake Marketplace. 


## 12. Link to TLADS Canvases

The main methodologies and ways of thinking from which this project stems imitates the concepts talked about in the TLADS documents written by Bill Schmarzo. Of course, this type of a project cannot take on all of the suggested processes from this book because the project is not actually being implemented with a CEX. However, there is still a lot of value in terms of setting up this project in a way that mocks the type of analytic value that would be provided to a CEX by brainstorming in the correct ways, thinking about business relevance throughout everything that is being built, and also in building the type of models and analytics that suit strong practices.

The concept relating to "nanoeconomics" is what has really been taken on board when looking at this project and what it has produced. This means moving away from simply looking at averages and instead analysing granular, entity-level predicted behavioural and performance propensities which can be seen in trying to model wallet behaviour on a granular way by producing analytic scores and profiles for each wallet. This allows for a different type of decision making, one more focused on precision and in targeting particular groups which heavily ties in with the identification of "behavioural archetype" groups in onchain crypto data.

The TLADS canvases are included in this repository and include notation of all my thinking throughout production of analytic scores and how they link in with informing business decisions. This process of course is not the same as in practice with a real implementation of analytics with a business as it heavily relies on stakeholder input (a bit like the feedback loop for the output mentioned earlier) to identify the most important changes and work to improve key decision making for these stakeholders. These TLADS canvases also make reference to the type of KPIs and metrics available to a CEX for which this project of course has no access to. Again, this is included to demonstate and understand the business-aligned thinking behind all the models and feature engineering in this repository, even though they are not computed or used directly in such models.

## 13.  License

To see the license refer to the LICENSE document in this repository.
