...
from source_code_package.models.AS_1_functionality.train_model_1_source import train_linear_regression

#Calling of the train_linear_regression function to train the model:
train_linear_regression(config_path='source_code_package/config/config_AS_1.yaml')