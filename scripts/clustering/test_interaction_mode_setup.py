...
def test_dataset_files():
    ...
    base_data_dir = os.path.join(os.path.dirname(__file__), '../../data/raw_data')
...
def test_config_validation():
    ...
    try:
        from models.clustering_functionality.simplified_clustering import validate_hdbscan_config
